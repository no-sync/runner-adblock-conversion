...
"""
Generate a mihomo-compatible rule-provider YAML file.

The current domain extraction process does not preserve
the original source rule type, so all cleaned domains are
represented as DOMAIN-SUFFIX rules.
"""
...
New mihomo adblock.yaml output
